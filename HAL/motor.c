...
//inialize direction pins
   GPIO_InitPin(motorDirectionsPort,RIGHTMOTORDIRECTION,OUTPUT);
   GPIO_InitPin(motorDirectionsPort,LEFTMOTORDIRECTION,OUTPUT);
 ...
 ***********************************************************************/
 void setDirectionForward(uint8 motor){
   if(motor == RIGHT){
     ...
     GPIO_SetPin(motorDirectionsPort,RIGHTMOTORDIRECTION);

   }
   else if(motor == LEFT){
     //set right motor forward
	 GPIO_SetPin(motorDirectionsPort,LEFTMOTORDIRECTION);
 ...
 ***********************************************************************/
  void setDirectionBackword(uint8 motor){
    if(motor == RIGHT){
      ...
      GPIO_ClearPin(motorDirectionsPort,RIGHTMOTORDIRECTION);
    }
    else if(motor == LEFT){
      //set right motor backword
        GPIO_ClearPin(motorDirectionsPort,LEFTMOTORDIRECTION);
    }
  }
